...
export const Banner = () => {
  ...
  const toRotate = ["Web Developer", "Front-end Developer", "Junior Developer"];
  const period = 2000;
                  ...
                  >
                    ...
                    <h1>
                      ...
                      <span
                        ...
                        dataPeriod="1000"
                        data-rotate='[ "Web Developer", "Front-end Developer", "Junior Developer" ]'
                      >
            ...
            <TrackVisibility>
              {({ isVisible }) => (
                <div>
                  <Spline
                    className="spline"
                    scene="https://prod.spline.design/Kr8pFEdFrWwXLSIw/scene.splinecode"
                  />
                </div>
              )}
            </TrackVisibility>
